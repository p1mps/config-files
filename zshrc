...
export PATH=/usr/local/bin:/Users/p1mps/Library/sdk/tools:$PATH
export GDFONTPATH=/Users/p1mps/Library/Fonts
...
PROMPT="${fg_lgreen}%n@${fg_red}%m${at_underloff}${fg_white}[${fg_cyan}%~${fg_white}]:🍔 ${at_normal} "
