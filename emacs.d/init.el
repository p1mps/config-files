...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (evil-surround flycheck-phpstan flycheck-phanclient evil-magit cider exec-path-from-shell smartparens move-text ag eyebrowse gherkin-mode perspeen exwm dashboard fill-column-indicator company company-mode helm-projectile helm linum-mode dump-jump dumb-jump magit php-mode flycheck linum-relative use-package zenburn-theme evil-visual-mark-mode))))
(custom-set-faces
